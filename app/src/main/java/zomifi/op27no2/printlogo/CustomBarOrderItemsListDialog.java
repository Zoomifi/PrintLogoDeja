 ...
 */
public class CustomBarOrderItemsListDialog extends Dialog implements View.OnClickListener, CustomPriceEnteredListener,CustomManagerListener
{
    ...
    public CustomBarOrderItemsListDialog(Context context, String orderUniqueID)
    {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.dialog_baritemlist);
...
/*        showOrderVoidButton.setOnClickListener(new View.OnClickListener() {
        ...
        voidOrderButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mHelper.voidBarOrder(orderUniqueID);
                hideOrderVoid();
            }
        });
...
/*        showOrderCloseButton.setOnClickListener(new View.OnClickListener() {
        ...
        if(!orderUniqueID.equals("")) {
            mHelper.updateOrderTotal(thisRef.child("BarOrders").child(orderUniqueID));
            setupTextListeners();
        }
        ...
        Query preQuery = null;
            ...
            DatabaseReference myRef = thisRef.child("BarOrders");
    ...
    private void setupTextListeners(){
       mOrderQuery = thisRef.child("BarOrders").orderByKey().equalTo(orderUniqueID);
       mChildEventListener = new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
                // A new comment has been added, add it to the displayed list
               // IPEOrder mOrder = dataSnapshot.getChildren().iterator().next().getValue(IPEOrder.class);
                BarOrder mOrder = dataSnapshot.getValue(BarOrder.class);
                SimpleDateFormat df = new SimpleDateFormat("MM/dd     hh:mm:ss a");
