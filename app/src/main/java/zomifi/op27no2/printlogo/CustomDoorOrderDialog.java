 ...
 */
public class CustomDoorOrderDialog extends Dialog
{
    ...
    public CustomDoorOrderDialog(Context context)
    {
        super(context);
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.dialog_doororderlist);
        ...
        DatabaseReference myOrdersRef = thisRef.child("DoorOrders");

        Query query = thisRef.child("DoorOrders").limitToLast(page*30);

        mAdapter = new FirebaseRecyclerAdapter<BarOrder, OrderHolder>(BarOrder.class, R.layout.list_item_doororderitem, OrderHolder.class, query) {
            @Override
